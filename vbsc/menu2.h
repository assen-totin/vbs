...
static GtkItemFactoryEntry menu_entries[VBSC_MENU_COUNT] = {
	...
	{ "/Network/Receive from Network...", "", useNetwork2,  75, "<Item>" },
        { "/Network/Server...", "", setNetworkServer,  72, "<Item>" },
        { "/Network/Port...", "", setNetworkPort,  73, "<Item>" },
	{ "/Network/Magic Key...", "", setMagicKey,  74, "<Item>" },

	{ "/_Player",        "<ALT>P",      NULL,         0, "<Branch>" },
	{ "/Player/Full Screen...", "", setFullScreen,  81, "<Item>" },
	{ "/Player/Font Size...", "", setFontSize,  82, "<Item>" },
